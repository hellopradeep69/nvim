...
map("n", "<leader>fe", function() Snacks.picker.files() end, { desc = "Find Files Too" })
...
map("x", "<leader>sw", function() Snacks.picker.grep_word() end, { desc = "Visual selection or word" })
-- search
...
map("n", "gry", function() Snacks.picker.lsp_type_definitions() end, { desc = "Goto T[y]pe Definition" })
